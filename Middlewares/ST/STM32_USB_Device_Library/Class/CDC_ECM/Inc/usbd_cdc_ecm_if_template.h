...
#define CDC_ECM_MAC_STR_DESC                 (uint8_t *)"000202030000" //placeholder mac address
#define CDC_ECM_MAC_ADDR0                    0x00U /* 01 */
#define CDC_ECM_MAC_ADDR1                    0x00U /* 02 */
#define CDC_ECM_MAC_ADDR2                    0x00U /* 03 */
#define CDC_ECM_MAC_ADDR3                    0x00U /* 00 */
